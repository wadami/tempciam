...
<%
		...
		// Initial Page Load
				...
				if (incomingREFObj.containsKey("signedreqattr.claims"))
				{
						...
						JSONObject claimsObj = (JSONObject)incomingREFObj.get("signedreqattr.claims");
						Map idToken = (Map)claimsObj.get("id_token");
						Map intentObj = (Map)idToken.get("openbanking_intent_id");
						openbanking_intent_id = intentObj.get("value").toString();
